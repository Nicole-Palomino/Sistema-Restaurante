...
<jsp:useBean id="DatosProducto" class="model.BProducto" scope="request"></jsp:useBean>
<body>	
	...
	<div class="container mt-3">
		<div class="border border-4 w-50 mx-auto rounded-4 border-dark p-2 mb-2 border-opacity-50">
			<h3 class="text-center fw-bold fs-3">Actualizar datos del producto</h3>
			<form action="SActualizarProducto" method="post" class="w-75 mx-auto needs-validation">
			<div class="input-group flex-nowrap mt-4">
					<span class="input-group-text" id="addon-wrapping">
						<i class="bi bi-card-heading"></i>
					</span>
					<input type="text" class="form-control" name="txtSerie" value="<%=DatosProducto.getSerie()%>">
				</div>
				<div class="input-group flex-nowrap mt-4">
					<span class="input-group-text" id="addon-wrapping">
						<i class="bi bi-basket-fill"></i>
					</span>
					<input type="text" class="form-control" name="txtNombre" value="<%=DatosProducto.getNombre()%>">
				</div>
				<div class="input-group flex-nowrap mt-4">
					<span class="input-group-text" id="addon-wrapping">
						<i class="bi bi-tags-fill"></i>
					</span>
					<input type="text" class="form-control" name="txtPrecio" value="<%=DatosProducto.getPrecio() %>">
				</div>
				<div class="input-group flex-nowrap mt-4">
					<span class="input-group-text" id="addon-wrapping">
						<i class="bi bi-receipt-cutoff"></i>
					</span>
					<input type="text" class="form-control" name="txtStock" value="<%=DatosProducto.getStock() %>">
				</div>
				<div class="form-group mt-2 mb-3">
				    <button type="submit" class="btn btn-success mt-2 w-100">ACTUALIZAR</button>
				    <a class="btn btn-danger mt-2 w-100" href="SListaProducto">CANCELAR</a>
				</div>
				
				<input type="hidden" name="codigo" value="<%= DatosProducto.getIdproducto() %>">
			</form>
		</div>
	</div>
